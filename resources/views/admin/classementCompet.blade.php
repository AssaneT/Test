                ...
                @for ($i = 0; $i <= 20; $i++)
                    @foreach ($classements as $classement)
                        @if (($i == $classement->position) && ($classement->id_championnat == $championnats->id))
                            <tr>
                                {{--    <td class="border px-10 py-5"><img class="object-scale-down w-20 h-10" src="http://localhost/senfoot/storage/app/public/{{ $equipe->logo }}"></td>     --}}
                                ...
                                <td class="inline-flex text-center px-12 py-1">
                                    @foreach ($equipes as $equipe)
                                        @if ($equipe->nomequipe == $classement->equipe)
                                            <img class="object-scale-down w-8 h-7 mr-1" src="http://localhost/senfoot/storage/app/public/{{ $equipe->logo }}">
                                        @endif
                                    @endforeach
