                ...
                <div class="w-full container mx-auto flex flex-wrap items-center justify-start py-2">
                    <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:mt-0 bg-white lg:bg-transparent text-center p-4 lg:p-0">
                        <ul class="list-reset lg:flex justify-start text-white text-2xl flex-1 items-center">
                            <li class="mr-5">
                                <a class="inline-block no-underline hover:text-gray-300 hover:text-underline py-2 px-4" href="{{ route('pageModifEquipe',$equip->id) }}">General</a>
                            </li>
                            <li class="mr-5">
                                <a class="inline-block underline hover:text-gray-300 hover:text-underline py-2 px-4" href="{{route('pageEquipeCalend',$equip->id)}}">Calendrier</a>
                            </li>
                            <li class="mr-5">
    ...
    <div class="main-content flex-1 pb-24 md:pb-5">
        ...
        <div class="bg-gray-800">
            <div class="rounded-tl-3xl bg-gradient-to-r from-pink-900 to-gray-800 p-4 shadow text-2xl text-white">
                <h3 class="font-bold pl-2">Calendrier des matches</h3>
            </div>
        </div>
                ...
                @for ($i = $begin; $i <= $end; $i->modify('+1 day'))
                    @foreach ($matches as $matche)
                        ...
                        @if (($i == $date) && (($matche->equipeadv == $equip->nomequipe) || ($matche->equipedom == $equip->nomequipe)))
                            <div class="w-1/3 ml-24 rounded-lg text-2xl bg-pink-900 text-white py-2 mt-6"><span class="ml-6">@php echo date("d-m-Y", strtotime($matche->datematch)); @endphp</span></div>
                            <div class="flex justify-center">
                                <div class="w-2/3 ml-6 border border-gray-300 py-3 flex items-center justify-center hover:bg-blue-100">
                                    ...
                                    @if ($date_time_now <= $date_fin)
                                        <span class="box-border h-15 w-30 p-1 border text-black mr-4 ml-4">{{ $matche->heurematch }}</span>
                                    @else
