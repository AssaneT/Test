...
<body style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <form class="w-full mt-8" action="{{ route('updateModifStatMatch',$stat->id) }}" method="POST">
        @csrf
        ...
        <div class="mb-6 md:flex md:justify-evenly">
            <div class="mb-4 md:mr-2 md:mb-0">
                @foreach ($equipes as $equipe)
                    @if ($equipe->nomequipe == $matches->equipedom)
                        <img class="object-scale-down w-15 h-15" src="http://localhost/senfoot/storage/app/public/{{ $equipe->logo }}">
                    @endif
                @endforeach
            </div>
            <div class="md:ml-2">
        ...
        <div class="mb-6 md:flex md:justify-evenly">
            <div class="mb-4 md:mr-2 md:mb-0">
                ...
                <input
                    class="w-full px-8 py-2 text-sm leading-tight text-gray-700 text-center border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                    name="but_equipe_dom"
                    type="number"
                    min="0" max="50"
                    value="<?php echo "$stat->but_equipe_dom"; ?>"
                />
            </div>
            <div class="md:ml-2">
                <label class="block mb-2 text-sm text-center font-bold text-gray-700">
                ...
                <input
                    ...
                    type="number"
                    min="0" max="50"
                    value="<?php echo "$stat->but_equipe_adv"; ?>"
                />
            </div>
        </div>
        <div class="mb-6 md:flex md:justify-evenly">
            <div class="mb-4 md:mr-2 md:mb-0">
                ...
                <input
                    ...
                    type="number"
                    min="0" max="100"
                    value="<?php echo "$stat->tir_equipe_dom"; ?>"
                />
            </div>
            <div class="md:ml-2">
                <label class="block mb-2 text-sm text-center font-bold text-gray-700">
                ...
                <input
                    ...
                    type="number"
                    min="0" max="100"
                    value="<?php echo "$stat->tir_equipe_adv"; ?>"
                />
            </div>
        </div>
        <div class="mb-6 md:flex md:justify-evenly">
            <div class="mb-4 md:mr-2 md:mb-0">
                ...
                <input
                    class="w-full px-8 py-2 text-sm leading-tight text-gray-700 text-center border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                    name="tircadre_equipe_dom"
                    type="number"
                    min="0" max="100"
                    value="<?php echo "$stat->tircadre_equipe_dom"; ?>"
                />
            </div>
            <div class="md:ml-2">
                <label class="block mb-2 text-sm text-center font-bold text-gray-700">
                ...
                <input
                    class="w-full px-8 py-2 text-sm leading-tight text-gray-700 text-center border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                    name="tircadre_equipe_adv"
                    type="number"
                    min="0" max="100"
                    value="<?php echo "$stat->tircadre_equipe_adv"; ?>"
                />
            </div>
        </div>
        <div class="mb-6 md:flex md:justify-evenly">
            <div class="mb-4 md:mr-2 md:mb-0">
                ...
                <input
                    ...
                    type="number"
                    min="0" max="100"
                    value="<?php echo "$stat->possession_equipe_dom"; ?>"
                />
            </div>
            <div class="md:ml-2">
                <label class="block mb-2 text-sm text-center font-bold text-gray-700">
                ...
                <input
                    ...
                    type="number"
                    min="0" max="100"
                    value="<?php echo "$stat->possession_equipe_adv"; ?>"
                />
            </div>
        </div>
        <div class="mb-6 md:flex md:justify-evenly">
            <div class="mb-4 md:mr-2 md:mb-0">
                ...
                <input
                    ...
                    type="number"
                    min="0" max="1000"
                    value="<?php echo "$stat->passe_equipe_dom"; ?>"
                />
            </div>
            <div class="md:ml-2">
                <label class="block mb-2 text-sm text-center font-bold text-gray-700">
                ...
                <input
                    ...
                    type="number"
                    min="0" max="1000"
                    value="<?php echo "$stat->passe_equipe_adv"; ?>"
                />
            </div>
        </div>
        <div class="mb-6 md:flex md:justify-evenly">
            <div class="mb-4 md:mr-2 md:mb-0">
                ...
                <input
                    ...
                    type="number"
                    min="0" max="100"
                    value="<?php echo "$stat->faute_equipe_dom"; ?>"
                />
            </div>
            <div class="md:ml-2">
                <label class="block mb-2 text-sm text-center font-bold text-gray-700">
                ...
                <input
                    ...
                    type="number"
                    min="0" max="100"
                    value="<?php echo "$stat->faute_equipe_adv"; ?>"
                />
            </div>
        </div>
        <div class="mb-6 md:flex md:justify-evenly">
            <div class="mb-4 md:mr-2 md:mb-0">
                ...
                <input
                    class="w-full px-8 py-2 text-sm leading-tight text-gray-700 text-center border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                    name="cartonjaune_equipe_dom"
                    type="number"
                    min="0" max="22"
                    value="<?php echo "$stat->cartonjaune_equipe_dom"; ?>"
                />
            </div>
            <div class="md:ml-2">
                <label class="block mb-2 text-sm text-center font-bold text-gray-700">
                ...
                <input
                    class="w-full px-8 py-2 text-sm leading-tight text-gray-700 text-center border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                    name="cartonjaune_equipe_adv"
                    type="number"
                    min="0" max="22"
                    value="<?php echo "$stat->cartonjaune_equipe_adv"; ?>"
                />
            </div>
        </div>
        <div class="mb-6 md:flex md:justify-evenly">
            <div class="mb-4 md:mr-2 md:mb-0">
                ...
                <input
                    class="w-full px-8 py-2 text-sm leading-tight text-gray-700 text-center border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                    name="cartonrouge_equipe_dom"
                    type="number"
                    min="0" max="22"
                    value="<?php echo "$stat->cartonrouge_equipe_dom"; ?>"
                />
            </div>
            <div class="md:ml-2">
                <label class="block mb-2 text-sm text-center font-bold text-gray-700">
                ...
                <input
                    class="w-full px-8 py-2 text-sm leading-tight text-gray-700 text-center border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                    name="cartonrouge_equipe_adv"
                    type="number"
                    min="0" max="22"
                    value="<?php echo "$stat->cartonrouge_equipe_adv"; ?>"
                />
            </div>
        </div>
        <div class="mb-6 md:flex md:justify-evenly">
            <div class="mb-4 md:mr-2 md:mb-0">
                ...
                <input
                    class="w-full px-8 py-2 text-sm leading-tight text-gray-700 text-center border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                    name="horsjeu_equipe_dom"
                    type="number"
                    min="0" max="100"
                    value="<?php echo "$stat->horsjeu_equipe_dom"; ?>"
                />
            </div>
            <div class="md:ml-2">
                <label class="block mb-2 text-sm text-center font-bold text-gray-700">
                ...
                <input
                    class="w-full px-8 py-2 text-sm leading-tight text-gray-700 text-center border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                    name="horsjeu_equipe_adv"
                    type="number"
                    min="0" max="100"
                    value="<?php echo "$stat->horsjeu_equipe_adv"; ?>"
                />
            </div>
        </div>
        <div class="mb-6 md:flex md:justify-evenly">
            <div class="mb-4 md:mr-2 md:mb-0">
                ...
                <input
                    ...
                    type="number"
                    min="0" max="50"
                    value="<?php echo "$stat->corners_equipe_dom"; ?>"
                />
            </div>
            <div class="md:ml-2">
                <label class="block mb-2 text-sm text-center font-bold text-gray-700">
                ...
                <input
                    ...
                    type="number"
                    min="0" max="50"
                    value="<?php echo "$stat->corners_equipe_adv"; ?>"
                />
            </div>
        </div>
