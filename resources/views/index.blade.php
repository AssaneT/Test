    ...
    <div class="w-full inline-flex bg-white">
                                            ...
                                            <div class="px-10 py-2 ml-10 border border-gray-300 flex items-center justify-center bg-purple-100 hover:bg-blue-100">
                                                ...
                                                @foreach ($equipes as $equipe)
                                                    @if ($equipe->nomequipe == $matc->equipedom)
                                                        <img class="object-scale-down w-8 h-8" src="http://localhost/senfoot/storage/app/public/{{ $equipe->logo }}">
                                                    @endif
                                                @endforeach
        ...
        <div class="w-3/5 mt-2 space-x-5 space-y-5 mr-8">
            ...
            <a href="#" class="inline-block box-border h-80 w-60 p-6 bg-gray-100 border-2 border-gray-700">
                <img class="object-scale-down w-60 h-48" src="http://localhost/senfoot/public/images/ballon.jpg">
            ...
            <a href="#" class="inline-block box-border h-80 w-60 p-6 bg-gray-100 border-2 border-gray-700">
                <img class="object-scale-down w-60 h-48" src="http://localhost/senfoot/public/images/foot/image4.jpg">
                <div class="mb-1 italic">
                    l'incroyable but marquait par Papa Demba
                </div>
            </a>
            ...
            <a href="#" class="inline-block box-border h-80 w-60 p-6 bg-gray-100 border-2 border-gray-700">
                <img class="object-scale-down w-60 h-48" src="http://localhost/senfoot/public/images/foot/image1.jpg">
                <div class="italic">
            ...
            <a href="#" class="inline-block box-border h-80 w-60 p-6 bg-gray-100 border-2 border-gray-700">
                <img class="object-scale-down w-60 h-48" src="http://localhost/senfoot/public/images/foot/image9.jpg">
                <div class="italic">
            ...
            <a href="#" class="inline-block box-border h-80 w-60 p-6 bg-gray-100 border-2 border-gray-700">
                <img class="object-scale-down w-60 h-48" src="http://localhost/senfoot/public/images/foot/image10.jpg">
                <div class="italic">
            ...
            <a href="#" class="inline-block box-border h-80 w-60 p-6 bg-gray-100 border-2 border-gray-700">
                <img class="object-scale-down w-60 h-48" src="http://localhost/senfoot/public/images/foot/image6.jpg">
                <div class="italic">
            ...
            <a href="#" class="inline-block box-border h-80 w-60 p-6 bg-gray-100 border-2 border-gray-700">
                <img class="object-scale-down w-60 h-48" src="http://localhost/senfoot/public/images/foot/image8.jpg">
                <div class="italic">
            ...
            <a href="#" class="inline-block box-border h-80 w-60 p-6 bg-gray-100 border-2 border-gray-700">
                <img class="object-scale-down w-60 h-48" src="http://localhost/senfoot/public/images/foot/image5.jpg">
            ...
            <a href="#" class="inline-block box-border h-80 w-60 p-6 bg-gray-100 border-2 border-gray-700">
                <img class="object-scale-down w-60 h-48" src="http://localhost/senfoot/public/images/foot/image3.jpg">
                <div class="italic text-center">
